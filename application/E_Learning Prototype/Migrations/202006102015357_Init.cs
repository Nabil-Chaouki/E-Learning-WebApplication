namespace E_Learning_Prototype.Migrations
{
    ...
    public partial class Init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Information", "user_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Attachements", "Information_Id", "dbo.Information");
            ...
            DropIndex("dbo.Attachements", new[] { "Information_Id" });
